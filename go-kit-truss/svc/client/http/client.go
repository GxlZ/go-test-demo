...
func New(instance string, options ...ClientOption) (pb.UserServer, error) {
	var cc clientConfig
	...
	return svc.Endpoints{
		GetUsernameV1Endpoint: GetUsernameV1ZeroEndpoint,
	}, nil
}
...
// DecodeHTTPGetUsernameV1Response is a transport/http.DecodeResponseFunc that decodes
// a JSON-encoded Resp response from the HTTP response body.
// If the response has a non-200 status code, we will interpret that as an
// error and attempt to decode the specific error message from the response
// body. Primarily useful in a client.
func DecodeHTTPGetUsernameV1Response(_ context.Context, r *http.Response) (interface{}, error) {
...
// EncodeHTTPGetUsernameV1ZeroRequest is a transport/http.EncodeRequestFunc
// that encodes a getusernamev1 request into the various portions of
// the http request (path, query, and body).
func EncodeHTTPGetUsernameV1ZeroRequest(_ context.Context, r *http.Request, request interface{}) error {
	strval := ""
	_ = strval
	req := request.(*pb.Req)
	_ = req
